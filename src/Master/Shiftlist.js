    ...
    <div className="p-3 bg-white shadow-md rounded-md">
      ...
      <table className="w-full table-auto border border-dorika-blue">
        <thead className="bg-dorika-blue text-white text-sm">
          <tr>
            <th className="border border-dorika-blue px-2 py-1">Shift ID</th>
            ...
            <th className="border border-dorika-blue px-2 py-1">Break (min)</th>
          ...
          {shifts.length > 0 ? (
            shifts.map((s) => (
              <tr key={s._id} className="hover:bg-dorika-blueLight transition">
                <td className="border border-dorika-blue px-2 py-1">{s.shiftID}</td>
                <td className="border border-dorika-blue px-2 py-1">{s.shiftName}</td>
                <td className="border border-dorika-blue px-2 py-1">{s.startTime}</td>
                <td className="border border-dorika-blue px-2 py-1">{s.endTime}</td>
                <td className="border border-dorika-blue px-2 py-1">{s.breakDuration}</td>
                <td className="border border-dorika-blue px-2 py-1">{s.status}</td>
